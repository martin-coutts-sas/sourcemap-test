...
import { control } from './sourcemap-mobile-three.control';
import { SmiWindow, isSasMobileWindowApi, } from '@sassoftware/mobile-investigator';

@NgModule({
  imports: [CommonModule, FormsModule, SourcemapMobileThreeComponent],
  exports: [SourcemapMobileThreeComponent],
  providers: [
    {
      ...
      useFactory: (injector: Injector) => {
        return () => {
          customElements.define(
            ...
            createCustomElement(SourcemapMobileThreeComponent, { injector: injector })
          );
...
export class SourcemapMobileThreeModule {}
